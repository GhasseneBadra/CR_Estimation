...
namespace test1._1 {
    ...
    public partial class testDataSet : global::System.Data.DataSet {
        ...
        public partial class CR_EstimationDataTable : global::System.Data.TypedTableBase<CR_EstimationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CR_EstimationRow AddCR_EstimationRow(int id, int crm_id, string requirement_id, string requirement_from_original_id, string object_type) {
...
namespace test1._1.testDataSetTableAdapters {
    ...
    public partial class CR_EstimationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[CR_Estimation] ([id], [crm_id], [requirement_id], [requirement_from_original_id], [object_type]) VALUES (@id, @crm_id, @requirement_id, @requirement_from_original_id, @object_type);
SELECT id, crm_id, requirement_id, requirement_from_original_id, object_type FROM CR_Estimation WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CR_Estimation] SET [id] = @id, [crm_id] = @crm_id, [requirement_id] = @requirement_id, [requirement_from_original_id] = @requirement_from_original_id, [object_type] = @object_type WHERE (([id] = @Original_id) AND ((@IsNull_crm_id = 1 AND [crm_id] IS NULL) OR ([crm_id] = @Original_crm_id)) AND ((@IsNull_requirement_id = 1 AND [requirement_id] IS NULL) OR ([requirement_id] = @Original_requirement_id)) AND ((@IsNull_requirement_from_original_id = 1 AND [requirement_from_original_id] IS NULL) OR ([requirement_from_original_id] = @Original_requirement_from_original_id)) AND ((@IsNull_object_type = 1 AND [object_type] IS NULL) OR ([object_type] = @Original_object_type)));
SELECT id, crm_id, requirement_id, requirement_from_original_id, object_type FROM CR_Estimation WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::test1._1.Properties.Settings.Default.testConnectionString;
        }
        ...
        public virtual int Fill(testDataSet.CR_EstimationDataTable dataTable) {
        ...
        public virtual testDataSet.CR_EstimationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            testDataSet.CR_EstimationDataTable dataTable = new testDataSet.CR_EstimationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(testDataSet.CR_EstimationDataTable dataTable) {
        ...
        public virtual int Insert(int id, global::System.Nullable<int> crm_id, string requirement_id, string requirement_from_original_id, string object_type) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(id));
            if ((crm_id.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((int)(crm_id.Value));
            }
            else {
            ...
            if ((requirement_id == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(requirement_id));
            }
            if ((requirement_from_original_id == null)) {
                this.Adapter.InsertCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(requirement_from_original_id));
            }
            if ((object_type == null)) {
        ...
        public virtual int Update(int id, global::System.Nullable<int> crm_id, string requirement_id, string requirement_from_original_id, string object_type, int Original_id, global::System.Nullable<int> Original_crm_id, string Original_requirement_id, string Original_requirement_from_original_id, string Original_object_type) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(id));
            if ((crm_id.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(crm_id.Value));
            }
            else {
            ...
            if ((requirement_id == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(requirement_id));
            }
            if ((requirement_from_original_id == null)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(requirement_from_original_id));
            }
            if ((object_type == null)) {
            ...
            if ((Original_crm_id.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_crm_id.Value));
            }
            else {
        ...
        public virtual int Update(global::System.Nullable<int> crm_id, string requirement_id, string requirement_from_original_id, string object_type, int Original_id, global::System.Nullable<int> Original_crm_id, string Original_requirement_id, string Original_requirement_from_original_id, string Original_object_type) {
            return this.Update(Original_id, crm_id, requirement_id, requirement_from_original_id, object_type, Original_id, Original_crm_id, Original_requirement_id, Original_requirement_from_original_id, Original_object_type);
        }
    }
